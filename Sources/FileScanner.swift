...
enum FileScanner {
    ...
    static func scanDeveloperArtifacts() -> [DeveloperArtifact] {
        ...
        add("Library/Developer/Xcode/DerivedData", title: "DerivedData", detail: String(localized: "Indexy a výsledky sestavení; Xcode je znovu vytvoří"), category: .xcode, kind: .cache, recommended: true)
        add("Library/Developer/Xcode/Archives", title: String(localized: "Archivy aplikací"), detail: String(localized: "Historické distribuční buildy a dSYM"), category: .xcode, kind: .archive, recommended: false)
        add("Library/Developer/Xcode/iOS DeviceSupport", title: String(localized: "Podpora iOS zařízení"), detail: String(localized: "Symboly dříve připojených verzí iOS"), category: .xcode, kind: .cache, recommended: true)
        add("Library/Developer/CoreSimulator/Caches", title: String(localized: "Cache simulátorů"), detail: String(localized: "Dočasná data CoreSimulatoru"), category: .xcode, kind: .cache, recommended: true)
        addChildren(of: "Library/Developer/CoreSimulator/Devices", category: .xcode, kind: .simulator, detail: String(localized: "Zařízení Apple Simulator"))

        add(".gradle/caches", title: String(localized: "Gradle cache"), detail: String(localized: "Stažené závislosti a výsledky sestavení"), category: .android, kind: .cache, recommended: true)
        add(".gradle/daemon", title: String(localized: "Gradle daemon"), detail: String(localized: "Dočasná data a logy Gradle procesů"), category: .android, kind: .cache, recommended: true)
        add(".android/cache", title: "Android cache", detail: String(localized: "Dočasná data Android nástrojů"), category: .android, kind: .cache, recommended: true)
        addChildren(of: ".android/avd", category: .android, kind: .simulator, detail: "Android Virtual Device")
        addChildren(of: "Library/Android/sdk/system-images", category: .android, kind: .runtime, detail: String(localized: "Obraz systému Android Emulatoru"))
        ...
        add(".npm/_cacache", title: "npm cache", detail: String(localized: "Cache stažených npm balíčků"), category: .node, kind: .cache, recommended: true)
        add(".npm/_logs", title: "npm logy", detail: String(localized: "Diagnostické záznamy npm"), category: .node, kind: .logs, recommended: true)
        add(".node-gyp", title: "node-gyp cache", detail: String(localized: "Hlavičky pro kompilaci nativních modulů"), category: .node, kind: .cache, recommended: true)
        add(".pnpm-store", title: "pnpm store", detail: String(localized: "Globální úložiště balíčků pnpm"), category: .node, kind: .cache, recommended: false)
        add("Library/Caches/Yarn", title: String(localized: "Yarn cache"), detail: String(localized: "Cache balíčků Yarn"), category: .node, kind: .cache, recommended: true)
        addChildren(of: ".nvm/versions/node", category: .node, kind: .runtime, detail: String(localized: "Node.js runtime spravovaný přes nvm"))
        addChildren(of: "/opt/homebrew/lib/node_modules", category: .node, kind: .package, detail: String(localized: "Globální npm balíček"), canRemove: false)
        addChildren(of: "/usr/local/lib/node_modules", category: .node, kind: .package, detail: String(localized: "Globální npm balíček"), canRemove: false)

        add("Library/Caches/Homebrew", title: "Homebrew cache", detail: String(localized: "Stažené archivy a metadata Homebrew"), category: .homebrew, kind: .cache, recommended: true)
        add("Library/Logs/Homebrew", title: "Homebrew logy", detail: String(localized: "Logy instalací a sestavení"), category: .homebrew, kind: .logs, recommended: true)
        addChildren(of: "/opt/homebrew/Cellar", category: .homebrew, kind: .package, detail: String(localized: "Nainstalovaná Homebrew formule"), canRemove: false)
        addChildren(of: "/opt/homebrew/Caskroom", category: .homebrew, kind: .package, detail: String(localized: "Nainstalovaný Homebrew cask"), canRemove: false)
        addChildren(of: "/usr/local/Cellar", category: .homebrew, kind: .package, detail: String(localized: "Nainstalovaná Homebrew formule"), canRemove: false)
        addChildren(of: "/usr/local/Caskroom", category: .homebrew, kind: .package, detail: String(localized: "Nainstalovaný Homebrew cask"), canRemove: false)

        add(".m2/repository", title: "Maven repository", detail: String(localized: "Lokální cache Maven závislostí"), category: .java, kind: .cache, recommended: false)
        add(".gradle/wrapper/dists", title: String(localized: "Gradle distribuce"), detail: String(localized: "Stažené verze Gradle"), category: .java, kind: .runtime, recommended: false)
        addChildren(of: "Library/Java/JavaVirtualMachines", category: .java, kind: .runtime, detail: String(localized: "Uživatelská instalace JDK"))
        addChildren(of: "/Library/Java/JavaVirtualMachines", category: .java, kind: .runtime, detail: String(localized: "Systémová instalace JDK"), canRemove: false)
